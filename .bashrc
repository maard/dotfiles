...
ps1_user(){
  if [ -n "$USER" -a "$USER" != "maksymiemelianov" ]; then
    echo "$USER "
  else
    echo ""
  fi
...
export KUBECONFIG=${KUBECONFIG:+$KUBECONFIG:}/Users/maksymiemelianov/.kube/config:/Users/maksymiemelianov/.kube/config.shopify.cloudplatform
